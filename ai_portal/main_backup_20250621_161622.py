...
# --- Import Database Models (MODULARIZED) ---
from ai_portal.models import (
    Base, engine, SessionLocal, create_tables, get_db_session, test_connection, close_engine,
    Project, Persona, ChatHistory, ProjectSettings
)
...
class UnifiedAIPortal:
    def __init__(self, config_file: str = "config.yaml"):
        ...
        # Initialize database using modular components
        ...
        # Create database tables using modular function
        try:
            create_tables()
        except Exception as e:
    ...
    def _get_or_create_default_project(self, session, user_id: str) -> uuid.UUID:
        ...
        return Project.get_or_create_default(session, user_id)
